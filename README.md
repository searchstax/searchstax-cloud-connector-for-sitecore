...
```PS> Invoke-RestMethod -Uri $url -Credential $credential -ContentType 'application/json' -Method POST -Body $json``` - reference: https://lucene.apache.org/solr/guide/8_6/schema-api.html
